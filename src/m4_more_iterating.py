...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [17, 50, 33, 29, 62, 44, 48, 98]
    threshold = 33
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [7.1, 7.0001, 7.0000001, 7, 49/7, 6.9999]
    threshold = 7
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 6
    actual = count_positive_sines([3, 5, 7, 9, 9, 7, 5, 3, 0])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 3
    actual = sum_first_n([0, 20, -30, 13], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
